...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By monster' : process.env.ALL_CAPTION,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/akbar__ofc/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '919677331878,0' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "919677331878-1627138839",
